...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* The six tabs are wider than a narrow phone. They scroll inside their own strip rather than
      ...
      {tab === 'train' ? <Trainer /> : tab === 'real' ? <RealQuiz /> : tab === 'ask' ? <AskHand /> : tab === 'shapes' ? <Shapes /> : tab === 'table' ? <TableSetup /> : <Replay />}
    </div>
  );
}
