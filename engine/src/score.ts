...
const FAN = {
  all_chow: 1, all_pong: 2, half_color: 2, half_terminal: 2, ping_wu: 4, full_color: 4,
  dragon_set: 7, concealed_all_pong: 7, thirteen_wonders: 8, all_terminal: 9,
  wind_set: 12, all_kong: 14,
  animal: 1, animal_set: 1, own_flower: 1, flower_set: 1, season_set: 1,
  dragon_pong: 1, prevailing_wind: 1, seat_wind: 1, two_dragons_eye: 1, three_winds_eye: 4,
  replacement_win: 1, last_tile: 1, robbing_kong: 1,
} as const;
