...
const CARDS: Tip[] = [
  {
    ...
    verdict: 'measured',
    verdictNote: 'The counting is clear on this pair of hands: the five-block one is ready and the six-block one is a tile further away, and it accepts more tiles, which is exactly the trap. The play-outs are not clear at all. On 262 graded positions across both packs holding six blocks where one could be cut for nothing, and where the book’s own exception on the next card did not apply, 202 resolved the choice and the measured best cut the sixth block 103 times — 51% against 54% by luck. The two populations agree: 56% against 57% at the coach table, 46% against 52% on the recorded run. So keep the rule for how it makes you SEE a hand, and do not treat the sixth block as an error.',
  },
  {
    id: 'six_blocks_ok',
    phase: 'build',
